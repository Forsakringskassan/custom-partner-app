    ...
    <div class="container">
        <div class="row">
            <div class="col col--md-6">
                <h1>Ge fullmakt åt apoteksärenden</h1>

                <f-text-field v-model="textFieldModel" maxlength="100">
                ...
                <f-select-field id="dropplista" v-model="selectFieldModel">
                ...
                <f-card>
                    <template #default>
                        <f-fieldset name="fullmakt-längd" border>
                ...
                <f-card>
                    ...
                    <template #footer>
                        <div class="button-group">
                            <button type="button" class="button button--full-width button--primary button-group__item">
                                Skicka in
                            </button>
                        </div>
                    </template>
